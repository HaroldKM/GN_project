...
ActiveRecord::Schema.define(version: 2019_11_21_092046) do
  ...
  create_table "accounts", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.string "image", default: "ubuntu-550x309.jpg"
    t.text "description"
    t.string "website"
  ...
  create_table "followers", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
